...
class DilemmaExceptional extends Component{
    ...
    control_filled = (args) => {
        if(this.state.answer1 != ""){
            ...
            axios.post(`https://congnitivee.herokuapp.com/sendExp/`, data )
            .then(res => {
        ...
        return(
            <div className="DillemPage">
              <div><h1> {this.props.number}. Şizofreni </h1>
                ...
                <h1 className="defaultText">Annenin, çocuklarını doyurmak için babalarını öldüren şizofreni adamdan para almasını değerlendiriniz.</h1>
                <Row className="row">
                ...
                <h1 className="defaultText">Annenin, çocuklarının babasını öldüren şizofreni adama aşık olmasını değerlendiriniz. </h1>
                <Row className="row">
